...
outmap_fd = os.path.join(root_path, "output_map_15oldcommunity_renew_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_15oldcommunity_renew_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "15oldcommunity_renew_ratio_gdb"), "15oldcommunity_renew_ratio.gdb") #手动添加
