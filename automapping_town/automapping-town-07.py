...
outmap_fd = os.path.join(root_path, "output_map_07fire_station_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_07fire_station_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "07fire_station_ratio_gdb"), "07fire_station_ratio.gdb") #手动添加
...
district_gdb = raw + r'边界带指标\town_clip.gdb'  ##边界带指标
