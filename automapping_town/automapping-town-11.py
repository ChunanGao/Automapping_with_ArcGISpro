...
outmap_fd = os.path.join(root_path, "output_map_11senior_service_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_11senior_service_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "11senior_service_ratio_gdb"), "11senior_service_ratio.gdb") #手动添加
