...
outmap_fd = os.path.join(root_path, "output_map_17green_transportation_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_17green_transportation_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "17green_transportation_ratio_gdb"), "17green_transportation_ratio.gdb") #手动添加
