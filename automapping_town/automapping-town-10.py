...
outmap_fd = os.path.join(root_path, "output_map_10community_service_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_10community_service_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "10community_service_ratio_gdb"), "10community_service_ratio.gdb") #手动添加
