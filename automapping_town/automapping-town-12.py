...
outmap_fd = os.path.join(root_path, "output_map_12kindergarten_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_12kindergarten_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "12kindergarten_ratio_gdb"), "12kindergarten_ratio.gdb") #手动添加
