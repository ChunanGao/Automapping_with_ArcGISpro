...
outmap_fd = os.path.join(root_path, "output_map_04pervious_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_04pervious_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "04pervious_ratio_gdb"), "04pervious_ratio.gdb") #手动添加
