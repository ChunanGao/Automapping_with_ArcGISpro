...
outmap_fd = os.path.join(root_path, "output_map_06hosp23stars_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_06hosp23stars_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "06hosp23stars_ratio_gdb"), "06hosp23stars_ratio.gdb") #手动添加
