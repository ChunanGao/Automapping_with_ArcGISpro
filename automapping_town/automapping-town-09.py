...
outmap_fd = os.path.join(root_path, "output_map_09complete_community_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_09complete_community_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "09complete_community_ratio_gdb"), "09complete_community_ratio.gdb") #手动添加
