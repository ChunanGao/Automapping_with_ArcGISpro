...
outmap_fd = os.path.join(root_path, "output_map_16urban_commute_time")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_16urban_commute_time")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "16urban_commute_time_gdb"), "16urban_commute_time.gdb") #手动添加
