...
# 设置文件夹路径
root_path = r"C:\Users\chuna\Desktop\CityDNA\2021-11-24\01_59Cities_Diagnosis\05Maps\auto_mapping\output_town" ##raw路径
outmap_fd = os.path.join(root_path, "output_map_20specialized_property_management_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_20specialized_property_management_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "20specialized_property_management_ratio_gdb"), "20specialized_property_management_ratio.gdb") #手动添加
...
district_gdb = raw + r'边界带指标02\town_clip.gdb'  ##边界带指标
