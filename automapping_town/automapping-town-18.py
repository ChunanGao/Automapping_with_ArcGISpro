...
outmap_fd = os.path.join(root_path, "output_map_18barrierfree_facility_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_18barrierfree_facility_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "18barrierfree_facility_ratio_gdb"), "18barrierfree_facility_ratio.gdb") #手动添加
