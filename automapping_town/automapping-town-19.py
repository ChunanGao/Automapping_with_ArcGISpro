...
outmap_fd = os.path.join(root_path, "output_map_19housing_expenditure_over50_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_19housing_expenditure_over50_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "19housing_expenditure_over50_ratio_gdb"), "19housing_expenditure_over50_ratio.gdb") #手动添加
...
district_gdb = raw + r'边界带指标03\town_clip.gdb'  ##边界带指标
