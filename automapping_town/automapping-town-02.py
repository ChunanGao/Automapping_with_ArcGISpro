...
outmap_fd = os.path.join(root_path, "output_map_02greenpark_ratio")  ##create outmap folder
outmxd_fd = os.path.join(root_path, "output_mxd_02greenpark_ratio")  ##create outmxd folder
mikfolder(outmap_fd)
mikfolder(outmxd_fd)
indi_gdb_path = os.path.join(os.path.join(root_path, "02greenpark_ratio_gdb"), "02greenpark_ratio.gdb") #手动添加
